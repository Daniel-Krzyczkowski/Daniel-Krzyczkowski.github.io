<h3 style="text-align:center;"><img class="alignnone wp-image-227" src="https://devislandblog.files.wordpress.com/2018/04/adb2c1.png?w=300" alt="" width="378" height="189" /></h3>
...
<p style="text-align:center;"><img class="alignnone wp-image-234" src="https://devislandblog.files.wordpress.com/2018/04/adb2c2.png?w=300" alt="" width="307" height="178" /></p>
In search window type "azure b2c" and select "Azure Active Directory B2C" resource. Click "Create" button:
<p style="text-align:center;"><img class="alignnone wp-image-236" src="https://devislandblog.files.wordpress.com/2018/04/adb2c3.png?w=300" alt="" width="477" height="116" /></p>
In the next tab select "Create a new Azure AD B2C Tenant":
<p style="text-align:center;"><img class="alignnone wp-image-240" src="https://devislandblog.files.wordpress.com/2018/04/adb2c4.png?w=300" alt="" width="471" height="146" /></p>
Then provide your organization name, initial domain name and country. Click "Create" button:
<p style="text-align:center;"><img class="alignnone wp-image-242" src="https://devislandblog.files.wordpress.com/2018/04/adb2c5.png?w=191" alt="" width="245" height="386" /></p>
Once AD is created you can manage it:

<img class=" wp-image-244 aligncenter" src="https://devislandblog.files.wordpress.com/2018/04/adb2c6.png?w=300" alt="" width="455" height="126" />
...
<p style="text-align:center;"><img class="alignnone wp-image-247" src="https://devislandblog.files.wordpress.com/2018/04/adb2c7.png?w=300" alt="" width="493" height="207" /></p>
Click on the alert to proceed. There is clear information displayed how to link AD B2C with Azure subscription:
<p style="text-align:center;"><img class="alignnone wp-image-250" src="https://devislandblog.files.wordpress.com/2018/04/adb2c8.png?w=300" alt="" width="507" height="282" /></p>
...
<p style="text-align:center;"><img class="alignnone wp-image-236" src="https://devislandblog.files.wordpress.com/2018/04/adb2c3.png?w=300" alt="" width="501" height="122" /></p>
Now select "Link an existing Azure AD B2C Tenant to my Azure subscription":
<p style="text-align:center;"><img class="alignnone wp-image-254" src="https://devislandblog.files.wordpress.com/2018/04/adb2c9.png?w=300" alt="" width="510" height="63" /></p>
Choose Tenant, Subscription and optionally create new resource group (you can use existing):
<p style="text-align:center;"><img class="alignnone wp-image-256" src="https://devislandblog.files.wordpress.com/2018/04/adb2c10.png?w=204" alt="" width="244" height="359" /></p>
<p style="text-align:center;"><img class="alignnone size-medium wp-image-258" src="https://devislandblog.files.wordpress.com/2018/04/adb2c11.png?w=300" alt="" width="300" height="103" /></p>
Once you click "Go to resource" and then click on the square with the name of your Tenant:
<p style="text-align:center;"><img class="alignnone wp-image-260" src="https://devislandblog.files.wordpress.com/2018/04/adb2c12.png?w=300" alt="" width="343" height="319" /></p>
Azure AD B2C is ready:
<p style="text-align:center;"><img class="alignnone wp-image-262" src="https://devislandblog.files.wordpress.com/2018/04/adb2c13.png?w=300" alt="" width="486" height="270" /></p>
...
<p style="text-align:center;"><img class="alignnone wp-image-268" src="https://devislandblog.files.wordpress.com/2018/04/adb2c14.png?w=283" alt="" width="205" height="217" /></p>
Click "Add" button. Blade with configuration should be displayed:
<p style="text-align:center;"><img class="alignnone wp-image-271" src="https://devislandblog.files.wordpress.com/2018/04/adb2c15.png?w=145" alt="" width="189" height="391" /></p>
...
<p style="text-align:center;"><img class="alignnone wp-image-274" src="https://devislandblog.files.wordpress.com/2018/04/adb2c16.png?w=300" alt="" width="475" height="253" /></p>
...
<img class=" wp-image-279 aligncenter" src="https://devislandblog.files.wordpress.com/2018/04/adb2c17.png?w=300" alt="" width="395" height="158" />

and standard registration with email and password as "Identity Provider":
<p style="text-align:center;"><img class="alignnone wp-image-280" src="https://devislandblog.files.wordpress.com/2018/04/adb2c18.png?w=300" alt="" width="373" height="128" /></p>
Once you click "Create" button policy should be displayed:
<p style="text-align:center;"><img class="alignnone wp-image-282" src="https://devislandblog.files.wordpress.com/2018/04/adb2c19.png?w=257" alt="" width="316" height="369" /></p>
...
<img class="alignnone wp-image-285" src="https://devislandblog.files.wordpress.com/2018/04/adb2c20.png?w=300" alt="" width="454" height="280" /></p>
...
<p style="text-align:center;"><img class="alignnone wp-image-289" src="https://devislandblog.files.wordpress.com/2018/04/adb2c21.png?w=268" alt="" width="360" height="402" /></p>
Once you click "Create" button application should be displayed on the list:
<p style="text-align:center;"><img class="alignnone wp-image-292" src="https://devislandblog.files.wordpress.com/2018/04/adb2c22.png?w=300" alt="" width="390" height="375" /></p>
&nbsp;
...
<p style="text-align:center;"><img class="alignnone wp-image-297" src="https://devislandblog.files.wordpress.com/2018/04/adb2c23.png?w=300" alt="" width="423" height="261" /></p>
<p style="text-align:center;"><img class="alignnone wp-image-299" src="https://devislandblog.files.wordpress.com/2018/04/adb2c24.png?w=300" alt="" width="426" height="278" /></p>
Add "Microsoft.AspNetCore.Authentication.JwtBearer" NuGet package:

<img class=" wp-image-301 aligncenter" src="https://devislandblog.files.wordpress.com/2018/04/adb2c25.png?w=300" alt="" width="432" height="141" />
...
<img class=" wp-image-309 aligncenter" src="https://devislandblog.files.wordpress.com/2018/04/adb2c26.png?w=300" alt="" width="379" height="308" />
...
<p style="text-align:center;"><img class="alignnone wp-image-311" src="https://devislandblog.files.wordpress.com/2018/04/adb2c27.png?w=300" alt="" width="366" height="349" /></p>
Fill all required data. After successful authentication token should be returned in URL:
<p style="text-align:center;"><img class="alignnone wp-image-313" src="https://devislandblog.files.wordpress.com/2018/04/adb2c28.png?w=300" alt="" width="586" height="23" /></p>
...
<img class=" wp-image-316 aligncenter" src="https://devislandblog.files.wordpress.com/2018/04/adb2c29.png?w=300" alt="" width="485" height="183" />

After adding token in header I am able to get values from API:
<p style="text-align:center;"><img class="alignnone wp-image-320" src="https://devislandblog.files.wordpress.com/2018/04/adb2c30.png?w=300" alt="" width="490" height="198" /></p>
